...
using FluentBitwarden.AppHost.Infrastructure.WebAuthn.Internal;

namespace FluentBitwarden.AppHost.Infrastructure.WebAuthn;

public static unsafe class WebAuthnLoginAssertionHelper
{
    private const string PublicKeyCredentialType = "public-key";
    private const string Sha256HashAlgorithm = "SHA-256";

    public static WebAuthnLoginAssertionResponseRequest GetAssertion(WebAuthnLoginAssertionOptions options, nint hwnd)
    {
