...
namespace FluentBitwarden.AppHost.Modules.Accounts.ApiAccess.Storage;

internal sealed class SecureRefreshTokenStore(SqliteTransaction transaction) : BaseRepository(transaction)
{
