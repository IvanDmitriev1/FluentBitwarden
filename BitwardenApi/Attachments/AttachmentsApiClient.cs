...
public sealed class AttachmentsApiClient(HttpClient httpClient) : IAttachmentsApiClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        AttachmentUploadInit? payload = await response.Content.ReadFromJsonAsync<AttachmentUploadInit>(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var payload = await response.Content.ReadFromJsonAsync<AttachmentUploadRenewal>(
            BitwardenApiJsonContext.Default.Options,
            cancellationToken);
