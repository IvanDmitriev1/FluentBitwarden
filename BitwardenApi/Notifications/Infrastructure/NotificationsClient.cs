...
using BitwardenApi.Notifications.Serialization;
    ...
    : INotificationsClient
{
    ...
    private HubConnection CreateConnection(Uri hubEndpoint)
    {
        HubConnection connection = new HubConnectionBuilder()
            ...
            {
                options.PayloadSerializerOptions = BitwardenNotificationsJsonContext.ConfiguredDefault.Options;
            })
    ...
    public Task DispatchAsync(NotificationEnvelope notificationEnvelope) =>
        ...
        {
            NotificationType.SyncCipherCreate => PublishAsync(notificationEnvelope.Payload, BitwardenNotificationsJsonContext.ConfiguredDefault.CipherChangedNotification),
            NotificationType.SyncCipherUpdate => PublishAsync(notificationEnvelope.Payload, BitwardenNotificationsJsonContext.ConfiguredDefault.CipherChangedNotification),
            NotificationType.SyncCipherDelete => PublishAsync(notificationEnvelope.Payload, BitwardenNotificationsJsonContext.ConfiguredDefault.CipherChangedNotification),

            NotificationType.SyncFolderCreate => PublishAsync(notificationEnvelope.Payload, BitwardenNotificationsJsonContext.ConfiguredDefault.FolderChangedNotification),
            NotificationType.SyncFolderUpdate => PublishAsync(notificationEnvelope.Payload, BitwardenNotificationsJsonContext.ConfiguredDefault.FolderChangedNotification),
            NotificationType.SyncFolderDelete => PublishAsync(notificationEnvelope.Payload, BitwardenNotificationsJsonContext.ConfiguredDefault.FolderChangedNotification),
            ...
            NotificationType.SyncVault
                ...
                PublishAsync(notificationEnvelope.Payload, BitwardenNotificationsJsonContext.ConfiguredDefault.VaultSyncRequestedNotification),
